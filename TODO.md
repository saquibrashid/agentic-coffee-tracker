...
| —                                                                         | Multi-device sync (v2)             | Specced end-to-end in `specs/sync.md`: SWA auth, Cosmos + Blob, `seq`-cursor pull/push, last-write-wins. Delivery is phased 0–8; phase 5 (two-device E2E green) is the milestone. Phases 0 and 1 are shipped; all open questions are resolved (`specs/sync.md` §Decisions). |
